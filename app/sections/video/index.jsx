...
export default function VideoSection() {
  ...
  return (
    <LazyMotion features={domAnimation}>
      <section ref={videoRef} className="relative w-screen h-screen overflow-hidden">
        <video className="w-full h-full object-cover" autoPlay loop muted playsInline src="/Video.mp4" poster="/fallback.jpg" />
